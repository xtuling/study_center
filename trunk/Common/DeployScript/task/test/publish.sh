...
TEMP_DIR="/data/wwwroot/publish_tmp_dir/thr_temp"                   # 部署临时目录
DEPLOY_DIR="/data/wwwroot/thr.vchangyi.com"                         # 部署生产目录
BAK_DIR="/data/wwwroot/publish_tmp_dir/thr_bak"                     # 部署备份目录
